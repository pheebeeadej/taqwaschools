               ...
               <div class="container">
                  <div class="page-title-content">
                     ...
                     <ul>
                        ...
                        <li>About</li> <li>Governing Council</li>
                     </ul>
                  </div>
               </div>
            </div>
                ...
                <section id="features" class="features-area pb-70">
                    <div class="container">
                     <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="single-features">
                                        <img src="assets/img/male.jpg" alt="" style="height: 200px; border-radius: 50%;">
                                    <h4>OLALERE ALIMI [Chairman]</h4>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                <div class="single-features">
                                    <img src="assets/img/female.jpg" alt="" style="height: 200px; border-radius: 50%;">
                                    <h4>MARYAM ALIMI [Vice Chairperson]</h4>
                                </div>
                                </div>
                              </div>
                         </div>
                         <div class="col-12">
                            <div class="row">
                                <div class="col-lg-1 mr"></div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="single-features">
                                        <img src="assets/img/male.jpg" alt="" style="height: 200px; border-radius: 50%;">
                                    <h4>BASHIR OLADEJO</h4>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-features">
                                        <img src="assets/img/male.jpg" alt="" style="height: 200px; border-radius: 50%;">
                                    <h4>LUQMAN OBILEYE</h4>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                <div class="single-features">
