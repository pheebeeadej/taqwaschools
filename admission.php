               ...
               <div class="col-lg-12 col-md-12">
                  <div class="blog-details-desc">
                     <div class="article-image mb-5">
                        <img src="assets/img/school_life/4.jpeg" alt="image" style="width: 100%; ">
                     </div>
                     <div class="article-content  pt-5">
                        <a class="btn btn-primary mb-5" href="assets/Student-admission-form.pdf" style="font-size: 20px;">
                            Download Admission Form
                            </a>
                        <p style="font-weight: bold; font-size: 20px;">Everyone at Taqwa works assiduously to create an engaging and nurturing environment to groom all learners to reach their potential. As part of our education, all learners must contribute their quota to school life.</p>
                        <p>How can we achieve this? We have created and developed an Admission process through which we understand every child’s current and potential ability. This will enable us to appreciate what levels we must reach to achieve his or her maximum capabilities.</p>
                        <p>The Prospectus and Admission Booklet <a href="#" style="color: blue;">can be downloaded here</a>
                            <br><br>
                            Submit your registration form <a href="#" style="color: blue;">here</a>
                            <br><br>
                            Please contact us if you would like to take a tour of our grounds.</p>
                        <blockquote class="wp-block-quote">
                           <p style="font-size: 15px !important;">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                           <cite>Taqwa Administrator</cite>
                        </blockquote>
                     </div>
                  </div>
               </div>
