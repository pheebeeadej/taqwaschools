...
<?php 
  $db = mysqli_connect('localhost', 'taqwaschools', 'Point066@@', 'taqwaschools');
        ...
        $fetchyyy = mysqli_query($db,"SELECT * FROM `updates` WHERE type = 'update' ORDER BY id DESC LIMIT $start_from, $per_page_record");
                      ...
                      while($fetch = mysqli_fetch_assoc($fetchyyy)){
                            ...
                            <div class="single-blog">
                              <div class="image">
                                  ...
                                  <img src="assets/img/school_life/'.$fetch["picture"].'" alt="image" style="width:100%;">
                                  </a>
                                  <div class="btn">
            ...
            ?>
              ...
              <div class="col-lg-12 col-md-12">
                  <div class="pagination-area">
                    <?php  
                        $query = "SELECT COUNT(*) FROM updates WHERE type = 'update'";     
